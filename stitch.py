    ...
    with open('data/STITCH - ATC/br08303.keg') as f:
        for line in f:
            if line[0] == "E":  # Interesting part of the doc
                ...
                tuple_br.append((line[9:16], line[17:][:-1]))
            else:
                pass
